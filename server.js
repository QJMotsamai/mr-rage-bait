...
app.post('/api/chat', async (req, res) => {
  ...
  const spice = ['mild', 'spicy', 'nuclear'].includes(req.body?.spice) ? req.body.spice : 'spicy';
  const activity = ['chat', 'rage', 'arcade'].includes(req.body?.activity) ? req.body.activity : 'chat';
